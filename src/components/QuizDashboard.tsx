...
import { Plus, Play, Edit3, Trash2, Copy, Users, Clock, BarChart3, Share2 } from 'lucide-react';
...
const QuizDashboard: React.FC<QuizDashboardProps> = ({ onCreateQuiz, onEditQuiz, onHostQuiz }) => {
  ...
  const loadQuizzes = () => {
    // Load all quizzes for demo purposes
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/70 text-lg">Create, manage, and host your quizzes</p>
        </div>
        ...
        {quizzes.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {quizzes.map((quiz) => {
              ...
              return (
                <div key={quiz.id} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/15 transition-all duration-300">
